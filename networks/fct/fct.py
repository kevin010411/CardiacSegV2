...
class FCT(nn.Module):
    ...
    def __init__(
        self, in_channels, out_channels, feature_size=8, deep_sup=False, drop_rate=0.3
    ):
        super().__init__()
        ...
        self.ds7 = DS_out(filters[6], out_channels)
        self.ds8 = DS_out(filters[7], out_channels)
        self.ds9 = DS_out(filters[8], out_channels)
